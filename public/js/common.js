var slides = document.querySelectorAll('#title__slides .slide');
var i = 0;
...
$(".bg_toggle").click(function() {
	if($(this).parent().parent().children("ul").is(":visible")) {
		...
		$(this).parent().parent().children(".mc_item_wrap_after").hide();
	} else
	 {
	$("body .mc_wrap .mc_item_wrap > ul , .mc_item_wrap_after").hide();
$(".mc_item_wrap").removeClass("active");
	$(this).parent().parent().addClass("active");
	$(this).parent().parent().children("ul").slideDown();
		$(this).parent().parent().children(".mc_item_wrap_after").show();
}
});
	...
	var eqElement = ".hi_items , .sb_content>div"
